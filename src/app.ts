...
const levels:NodeList=document.querySelectorAll('.levels')
...
const level11:HTMLElement=document.querySelector('.level11');
const level12:HTMLElement=document.querySelector('.level12');
const skip:HTMLElement=document.querySelector('.continue');
const skip2:HTMLElement=document.querySelector('.continue2');
const skip3:HTMLElement=document.querySelector('.continue3')
const logo:HTMLElement=document.querySelector('.logo');
const answers:HTMLElement=document.querySelector('.answers');
const test: HTMLElement = document.querySelector('#test');
const cloud:HTMLImageElement=document.querySelector('.cloud');
const description:HTMLElement=document.querySelector('.desc');
const chance1:HTMLInputElement=document.querySelector('.chance1');
const man2:HTMLImageElement=document.querySelector('.man2');
const cloud2:HTMLImageElement=document.querySelector('.cloud2');
const desc2:HTMLElement=document.querySelector('.desc2');
const again:HTMLElement=document.querySelector('.again');
const chance2:HTMLInputElement=document.querySelector('.chance2');
const chance3:HTMLInputElement=document.querySelector('.chance3');
const containerAnswer: HTMLElement=document.querySelector('.containerAnswer')
const desc4:HTMLDivElement=document.querySelector('.desc4');


const levelsArray:HTMLElement[]=Array.from(levels) as HTMLElement[];
...
function generateAnswer(randomAnswers: string | any[]){
...
if(numberOfChance===0){
  ...
  function checkAnswer(){
    ...
    const confirm:HTMLElement=document.querySelector('.confirm');
    const notConfirm:HTMLElement=document.querySelector('.notConfirm');
...
const cloud3:HTMLElement=document.querySelector('.cloud3');
const desc3:HTMLElement=document.querySelector('.desc3');
